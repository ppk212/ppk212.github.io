let contractAddress = '0x4e29b7d45b162168cca760787d069d24f61586c8';
let abi =
[
	{
		"constant": false,
...
function startApp() {
  ...
  simpleAuction = auctionContract.at(contractAddress);
...
function gethigh(){
	simpleAuction.getHighest(function(e,r){
		document.getElementById('highest_iphone7').innerHTML = r.toString();
	});
}
function getbid_value(){
	simpleAuction.getbid(function(e,r){
		document.getElementById('myself_iphone7').innerHTML = r.toString();
	});
}
function getEther() {
...
function voteForProduct(i) {
  let device_phone = $("#highest_iphone7").val();
	if (typeof device_phone == 'undefined')
		device_phone=0;
  let mybid = $("#tb_iphone7").val();
  simpleAuction.Bid(mybid, function (e, r){
